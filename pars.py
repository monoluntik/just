...
def pars():
    ...
    while True:
        ...
        time.sleep(5)
        gt = browser.current_url
        if gt != 'https://www.marathonbet.com/su/live/45356':
            print(gt)
            return 
        else:
            print("_________________", gt)
        browser.refresh()
        print('refresh')
            ...
            for match in matchess:
                ...
                for i in matchs:
                    ...
                    if set3 or set4:
                        ...
                        if max(team1) - min(team1) <= 12 and min(team1) >= 10:
                            team_main = I[1], team1, I[3]
                        elif max(team2) - min(team2) <= 12 and min(team2) >= 10:
